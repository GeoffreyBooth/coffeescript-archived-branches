...
(function() {
        ...
        if (param.splat || param instanceof Expansion) {
          ...
          if (!haveSplatParam) {
            ...
            if (((ref5 = param.name) != null ? ref5.value : void 0) != null) {
              o.scope.add(param.name.value, 'let', true);
            }
          }
        }
      }
  ...
  exports.Op = Op = (function(superClass1) {
    ...
    Op.prototype.compileNode = function(o) {
      ...
      if (this.operator === 'delete' && o.scope.check(this.first.unwrapAll().value)) {
        this.error('delete operand may not be argument or var/let/const');
      }
  ...
  UTILITIES = {
    extend: function(o) {
      return "function(child, parent) { for (let key in parent) { if (" + (utility('hasProp', o)) + ".call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }";
    },
    bind: function() {
