  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      constructor(variable1, value1, context1, options = {}) {
        ...
        this.param = options.param, this.subpattern = options.subpattern, this.operatorToken = options.operatorToken, this.moduleDeclaration = options.moduleDeclaration, this.wrapVariableInBraces = options.wrapVariableInBraces, this.wrapVariableInBrackets = options.wrapVariableInBrackets;
      }
      ...
      compileNode(o) {
        ...
        if (o.level > LEVEL_LIST || this.wrapVariableInBraces || this.wrapVariableInBrackets) {
          return this.wrapInParentheses(answer);
        } else {
          return answer;
        }
