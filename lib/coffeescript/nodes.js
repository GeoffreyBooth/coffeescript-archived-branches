...
(function() {
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      isDestructured() {
        return this.base instanceof Obj || this.base instanceof Arr;
      }
  ...
  exports.Obj = Obj = (function() {
    ...
    Obj.prototype.isAssignable = YES;
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      isDestructured() {
        return this.wrapVariableInBraces || this.wrapVariableInBrackets;
      }

      isAssignable() {
        return this.isDestructured() || this.defaultValue !== void 0;
      }
      ...
      compileNode(o) {
        ...
        if (this.defaultValue !== void 0) {
          ...
          compiledName = compiledName.concat(this.defaultValue.compileToFragments(o, LEVEL_LIST));
        }
        if (this.wrapVariableInBraces) {
          compiledName = this.wrapInBraces(compiledName);
        }
        if (this.wrapVariableInBrackets) {
          compiledName = this.wrapInBrackets(compiledName);
        }
        ...
        if (o.level > LEVEL_LIST || this.wrapVariableInBraces) {
          return this.wrapInParentheses(answer);
        } else {
          return answer;
        }
      ...
      compilePatternMatch(o) {
        var acc, assignOptions, assigns, code, defaultValue, expandedIdx, fragments, i, idx, isObject, ivar, j, len1, message, name, obj, objects, olen, ref, ref3, ref4, ref5, ref6, regularObjectPatternMatch, rest, top, val, value, vvar, vvarText;
        top = o.level === LEVEL_TOP;
        ({ value } = this);
        ...
        if (top && olen === 1 && !(obj instanceof Splat)) {
          ...
          if (obj instanceof Assign && obj.context === 'object') {
            regularObjectPatternMatch = true;
          ...
          if (regularObjectPatternMatch || obj["this"]) {
            ...
            assignOptions = {
              ...
              wrapVariableInBrackets: !isObject
            };
            if (defaultValue !== void 0) {
              assignOptions.defaultValue = defaultValue;
            }
    ...
    class Op extends Base {
      ...
      compileNode(o) {
        ...
        switch (this.operator) {
          ...
          case '??':
            return this.compileExistence(o, true);
          case '**':
    ...
    class Existence extends Base {
      ...
      compileNode(o) {
        ...
        if (this.expression.unwrap() instanceof IdentifierLiteral && !o.scope.check(code)) {
          ...
          code = `typeof ${code} ${cmp} \"undefined\" ${cnj} ${code} ${cmp} ${this.comparisonTarget}`;
        } else {
          code = `${code} ${(this.negated ? '==' : '!=')} ${this.comparisonTarget}`;
        }
  ...
  exports.For = For = (function() {
    class For extends While {
      constructor(body, source) {
        ...
        if (this.index instanceof Value && (this.index.isDestructured() || !this.index.isAssignable())) {
